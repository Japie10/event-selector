...
class MaskExporter:
    ...
    def export_both(
        ...
        capture_event_mask_path: Path,
        yaml_file: Optional[Path] = None
    ) -> None:
        """Export both event and capture mask files.

        Args:
            event_mask_data: Event mask data
            capture_mask_data: Capture mask data
            event_mask_path: Output path for event mask file
            capture_event_mask_path: Output path for capture mask file
        ...
        self.export_file(capture_mask_data, capture_event_mask_path, include_metadata=True, yaml_file=yaml_file)
